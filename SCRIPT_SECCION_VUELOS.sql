...
SELECT DISTINCT
	...
	C1.CIUDAD_ID				AS CIU_ORIG_ID,
	C2.CIUDAD_ID				AS CIU_DEST_ID
FROM gd_esquema.Maestra M 
LEFT JOIN LOS_SEQUEL_BLINDERS.CIUDAD C1
	ON M.RUTA_AEREA_CIU_DEST = C1.CIUDAD_NOMBRE
LEFT JOIN LOS_SEQUEL_BLINDERS.CIUDAD C2
	ON M.RUTA_AEREA_CIU_ORIG = C2.CIUDAD_NOMBRE
